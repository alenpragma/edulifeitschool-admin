...
const teacherSchema = z.object({
  ...
  profilePicture: z.any().optional(), // optional
});

export type UpdateTeacherInputs = z.infer<typeof teacherSchema>;
...
export default function UpdateTeacherModal({
  ...
  useEffect(() => {
    if (selectedItem) {
      ...
      setValue("subject", selectedItem.subject);
      setValue("qualification", selectedItem.qualification || "");
    } else {
      reset();
    }
  ...
  >({
    mutationFn: (formData) =>
      api
        .put(`/admin/teachers/${selectedItem?.id}`, formData)
        .then((res) => res.data),
    onSuccess: (data) => {
  ...
  const onSubmit = (data: UpdateTeacherInputs) => {
